...
<footer class="footer">
	<div class="l-footer">
		<h1>PopFood</h1>
       <p>
           PopFood.ru дает вам возможность купить пиццу и суши в городе Нижний Новгород, не выходя из дома.
   ...
   <ul class="r-footer">
       <li class="footerInfo">
        <ul class="box">
         ...
         <li><a href="index.php?page=reviews">Отзыв</a></li>
         <li> </li>
     </ul>
 </li>
 <li class="features">
    <ul class="box h-box">
     ...
     <li> <i class="iconNav fa-solid fa-location-dot"></i> г. Нижний Новгород, пр-т Ленина, д. 1</li>
