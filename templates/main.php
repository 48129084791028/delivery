    ...
    <div class="mainBlockContent">
        ...
        <p class="text">Заказывать очень удобно: вы можете воспользоваться этой услугой в любое удобное для вас время (попадающее в наш график работы). Наше меню отлично подходит перекусить в офисе вместе с коллегами: вы сможете не отрываться от рабочего процесса и насладиться вкуснейшими свежими блюдами, чтобы восстановить силы для дальнейших трудовых свершений. Не успеваете приготовить обед? На помощь приходит PopFood</p>
