...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 25 2022 г., 22:38
...
INSERT INTO `address` (`id`, `name_adr`, `address`) VALUES
(1, 'awd', 'dawd'),
(2, 'dwa', 'awdwa');
...
INSERT INTO `basket` (`id`, `id_user`, `id_product`, `number_product`, `status`) VALUES
(26, 25, 14, 3, 1);
...
INSERT INTO `users` (`id`, `name`, `login`, `email`, `password`, `phone`, `role`, `address`) VALUES
(25, 'Igor Prigarin', 'igor', 'igorprigarin2002@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '89527717069', NULL, NULL),
(26, 'admin', 'admin', 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, NULL);
...
ALTER TABLE `basket`
  ...
  ADD CONSTRAINT `basket_ibfk_3` FOREIGN KEY (`status`) REFERENCES `status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
